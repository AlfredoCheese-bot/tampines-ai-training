...
- Note Pro: 2.99mm, 30g, 4 MEMS + 1 VPU + AI beamforming, 5m pickup, 0.95" AMOLED InstantView, 64GB, dual-band Wi-Fi (BLE 5.4), Corning Gorilla Glass, Apple Find My (coming soon). Recording modes: Endurance up to 50hr (within 3m) / Enhance up to 30hr (up to 5m); **60-day standby** (official handguide — earlier "75 days" was wrong, corrected 2026-06-15). 112-language transcription, 300 free mins/mo. Officially sold at Changi via Metapod.
- NotePin S: 17.4g (without magnetic pin), 51×21×11mm, aluminium + polycarbonate, 2 MEMS, 4 wearing modes (wristband, clip, magnetic pin, lanyard) included, tactile button + Press to Highlight, 20hr/40-day standby, 64GB, Apple Find My (coming soon).
- PLAUD ecosystem (source: PLAUD_HANDGUIDE.pdf, 16pp image-only, rendered+read 2026-06-15 — both devices share the same app): "world's no.1 all-scenario AI note taker"; awards iF Design 2024 / Good Design 2024 / Red Dot 2024 + 2025; certs ISO 27001 + 27701, SOC 2 Type II, HIPAA, GDPR, EN 18031, TÜV SÜD; data flow capture-local → BT/Wi-Fi → optional AWS Private Cloud Sync → LLM processing (GPT-5.2/Gemini 3 Pro/Claude Sonnet 4.5) → export/delete; 10,000+ summary templates; AutoFlow (auto-email notes), Ask Plaud (Q&A over notes), Plaud Desktop (records online meetings, no bots), 27+ export formats. Membership: Free 300 min/mo · Pro 1,200 · Unlimited — prices in PDF are **USD** (do NOT surface; keep "scan QR for live iShopChangi price"). The plain "Plaud Note" ($159 USD) in the PDF is NOT one of our 6 booth products — exclude it.
